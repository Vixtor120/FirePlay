...
export default function CartPage() {
  ...
  useEffect(() => {
    const loadRecommendations = async () => {
      ...
      try {
        // Safe access to genres with optional chaining
                ...
                <div key={item.id} className="p-4 md:grid md:grid-cols-12 md:gap-4 md:items-center">
                  ...
                  <div className="hidden md:flex md:col-span-2 items-center justify-center">
                    <div className="flex items-center">
                      <button 
                        ...
                        className="px-2 py-1 bg-slate-700 hover:bg-slate-600 rounded-l text-white"
                      >
                        -
                      </button>
                      ...
                      <button 
                        ...
                        className="px-2 py-1 bg-slate-700 hover:bg-slate-600 rounded-r text-white"
                      >
                        +
                      </button>
                    </div>
                  ...
                  <div className="md:hidden flex justify-between items-center mt-3">
                    <div className="flex items-center gap-1">
                      <button 
                        onClick={() => updateQuantity(item.id, Math.max(1, item.quantity - 1))}
                        className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-700"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
